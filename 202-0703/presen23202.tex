...
\putnotew{120}{73}{\hyperlink{para2pg5}{\fbox{\Ctab{2.5mm}{\scalebox{1}{\scriptsize $\mathstrut \!\rhd\!\!|$}}}}}
...
\begin{itemize}
\item
$(e^x)'=\dlim_{z\to x}\bunsuu{e^z-e^x}{z-x}\phantom{=\dlim_{z\to x}\bunsuu{e^{x+(z-x)}-e^x}{z-x}}$\vspace{2mm}\\
\end{itemize}
%%%%%%%%%%%%%
...
\item
$(e^x)'=\dlim_{z\to x}\bunsuu{e^z-e^x}{z-x}=\dlim_{z\to x}\bunsuu{e^{x+(z-x)}-e^x}{z-x}$\vspace{2mm}\\
$\phantom{(e^x)'}=\dlim_{z\to x}\bunsuu{e^{x}e^{z-x}-e^x}{z-x}\phantom{=\dlim_{z\to x}\bunsuu{e^x(e^{z-x}-1)}{z-x}}$
\end{itemize}
