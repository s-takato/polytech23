...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='graphfr2.tex'
FnameR='graphfr2.r'
Fnameout='graphfr2.txt'
...
sg1=Listplot(c(c(2,0),c(2,4),c(0,4)))
pt1=Pointdata(list(c(2,4)))
cr1pt1=Circledata(c(c(2,4),0.152))
sc1pt1i=Scaledata(list(cr1pt1),1,1,c(0,0))
PtL=list()
GrL=list()
...
Openfile('/Users/takatoosetsuo/polytech23.git/108-0612/presen/fig/graphfr2.tex','5mm','Cdy=graphfr.cdy')
Fontsize('n')
Drwline(sght1)
Letter(c(-4,0),"s1","$-4$")
Drwline(sght2)
