...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='table1b.tex'
FnameR='table1b.r'
Fnameout='table1b.txt'
...
Openfile('/Users/takatoosetsuo/polytech23.git/101-0417/presen/fig/table1b.tex','1cm','Cdy=presen23101.cdy')
...
Letter(c(1.2,0.3),"c","$-9$")
Letter(c(2,0.3),"c","$-7$")
Letter(c(2.8,0.3),"c","$-5$")
Letter(c(3.6,0.3),"c","$-3$")
Letter(c(4.4,0.3),"c","$-1$")
Letter(c(5.2,0.3),"c","$1$")
Letter(c(6,0.3),"c","$3$")
Letter(c(6.8,0.3),"c","$5$")
Letter(c(7.6,0.3),"c","$7$")
Letter(c(8.4,0.3),"c","$9$")
Letter(c(9.2,0.3),"c","$11$")
Closefile("0")
