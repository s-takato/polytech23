...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='ippansankaku.tex'
FnameR='ippansankaku.r'
Fnameout='ippansankaku.txt'
...
Openfile('/Users/takatoosetsuo/polytech23.git/103-0515/presen/fig/ippansankaku.tex','1cm','Cdy=presen23104.cdy')
...
Letter(c(0.28,0.22),"ne","$\\theta$")
Letter(c(-0.95,0),"n1","$x$")
Letter(c(0,-1.76),"e1","$y$")
Letter(c(2,0),"s1e1","$r$")
Drwline(axx1)
Drwline(axy1)
Letter(c(2.4,0),"e","$x$")
