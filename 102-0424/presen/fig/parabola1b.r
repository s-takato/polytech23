...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='parabola1b.tex'
FnameR='parabola1b.r'
Fnameout='parabola1b.txt'
...
Setunitlen("7mm")
gr1=Plotdata('x^2','x')
sg1=Listplot(c(c(0,-5),c(0,5)))
pt1=Pointdata(list(c(0,0)))
cr1pt1=Circledata(c(c(0,0),0.095))
sc1pt1=Scaledata(list(cr1pt1),1,1,c(0,0))
...
Openfile('/Users/takatoosetsuo/polytech23.git/102-0424/presen/fig/parabola1b.tex','7mm','Cdy=presen23102.cdy')
