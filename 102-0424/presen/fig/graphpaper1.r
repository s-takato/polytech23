...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='graphpaper1.tex'
FnameR='graphpaper1.r'
Fnameout='graphpaper1.txt'
...
Openfile('/Users/takatoosetsuo/polytech23.git/102-0424/presen/fig/graphpaper1.tex','1cm','Cdy=200601.cdy')
