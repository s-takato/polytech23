...
\putnotee{80}{10}{\normalsize$\log_4 2+\log_4 8=\log_4 16=2$}
\putnotee{80}{21}{\normalsize$\log_3 15-\log_3 5=\log_3\dfrac{15}{5}=1$}
\putnotee{80}{32}{\normalsize$\log_2 2^5=5\log_2 2=5$}
\end{layer}
...
\begin{itemize}
\item
$y=\log_a x$のグラフを「関数のグラフ」でかこう\\
　$y=\log_2 x,\ \log_4 x,\ \log_{\frac{1}{2}}x$\\
注意：$x$の範囲が全実数でない　\verb|x=0.1,10|などとする\vspace{-2mm}
\item
[課題]\monban $y=\log_a x$のグラフについて（　）を埋めよ\seteda{100}\\
\eda{$a>1$のとき，右(　　　)}\\
\eda{[1]の範囲で$a$を大きくすると$x$軸(　　　)}\\
\eda{$0<a<1$のとき，右(　　　)}\\
\eda{[2]の範囲で$a$を大きくすると$x軸$(　　　)}
\end{itemize}
\label{pageend}\mbox{}
